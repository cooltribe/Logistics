...
public class LoginActivity1 extends BaseActivity implements OnClickListener, OnDataReceiveListener {
	...
	private void sub1() {
		try {
			...
			loginInfo.setPassword((MD5Util.getMD5String(login_userID.getText().toString() + login_password.getText().toString())).toLowerCase());
	...
	public void onClickListener(View view) {
		...
		case R.id.login_submit:
			doLoginSubmit();
			break;
//		case R.id.login_submit1:
//			sub1();
//			break;
//		case R.id.login_submit2:
//			sub2();
//			break;
		case R.id.registBtn:
			doRegister();
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case LOGIN_CODE_SUCCESS:
				Intent imIntent = new Intent(LoginActivity1.this, LoginIMServerService.class);
			...
			case LOGIN_CODE_USERNAME_UNINVAILED:
				login_userID.showPopWindow(LoginActivity1.this, msg.obj.toString());
				break;
			case LOGIN_CODE_PASSWORD_WRONG:
				login_password.showPopWindow(LoginActivity1.this, msg.obj.toString());
				break;
			case SHOW_PROGRESS:
				showProgress();
				break;
	...
	private void doResetPassword() {
		...
		Intent intent = new Intent(LoginActivity1.this, RetrievePasswordAuthcodeActivity.class);
		startActivity(intent);
	}
