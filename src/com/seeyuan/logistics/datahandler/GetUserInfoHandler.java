 ...
 * 
 */
public class GetUserInfoHandler extends DataHandler {
	private Context mContext;
	private String server_url;
	private PdaRequest<MemberDto> userInfo;

	public GetUserInfoHandler(Context context, PdaRequest<MemberDto> userInfo) {
		this.mContext = context;
		this.server_url = NetWork.GET_USERINFO_ACTION;
	...
	protected void onNetReceiveOk(byte[] receiveBody) {
		sendResult(NetWork.GET_USERINFO_OK, receiveBody);
	}

	@Override
	protected void onNetReceiveError(int errorCode) {
		sendResult(NetWork.GET_USERINFO_ERROR, errorCode);
	}
