 ...
 * 
 */
public class EditGoodsInfoHandler extends DataHandler {
	private Context mContext;
	private String server_url;
	private PdaRequest<GoodsDto> goodsDto;

	public EditGoodsInfoHandler(Context context, PdaRequest<GoodsDto> goodsDto) {
		this.mContext = context;
		this.server_url = NetWork.EDIT_GOODS_INFO_ACTION;
	...
	protected void onNetReceiveOk(byte[] receiveBody) {
		sendResult(NetWork.EDIT_GOODS_INFO_OK, receiveBody);
	}

	@Override
	protected void onNetReceiveError(int errorCode) {
		sendResult(NetWork.EDIT_GOODS_INFO_ERROR, errorCode);
	}
