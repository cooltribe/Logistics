 ...
 * 
 */
public class EditDriverHandler extends DataHandler {
	private Context mContext;
	private String server_url;
	private PdaRequest<DriverDto> driverInfo;

	public EditDriverHandler(Context context, PdaRequest<DriverDto> driverInfo) {
		this.mContext = context;
		this.server_url = NetWork.EDIT_DRIVER_INFO_ACTION;
	...
	protected void onNetReceiveOk(byte[] receiveBody) {
		sendResult(NetWork.EDIT_DRIVER_INFO_OK, receiveBody);
	}

	@Override
	protected void onNetReceiveError(int errorCode) {
		sendResult(NetWork.EDIT_DRIVER_INFO_ERROR, errorCode);
	}
