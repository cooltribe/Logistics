...
import com.seeyuan.logistics.activity.LoginActivity;
...
public class ChatMainActivity extends FragmentActivity {
	...
	public int getUnreadAddressCountTotal() {
		...
		if (ApplicationPool.getInstance().getContactList()
				.get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = ApplicationPool.getInstance()
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Map<String, User> localUsers = ApplicationPool.getInstance()
					.getContactList();
	...
	private void saveInviteMsg(InviteMessage msg) {
		...
		// 未读数加1
		User user = ApplicationPool.getInstance().getContactList()
		...
		public void onInvitationReceived(String groupId, String groupName,
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(ChatMainActivity.this)
	...
	private void showConflictDialog() {
		...
		ApplicationPool.getInstance().logout();
