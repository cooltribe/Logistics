...
public class ContactlistFragment extends Fragment {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (Constant.NEW_FRIENDS_USERNAME.equals(username)) {
					// 进入申请与通知页面
					User user = ApplicationPool.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME);
		...
		new Thread(new Runnable() {
			public void run() {
				try {
					...
					ApplicationPool.getInstance().getContactList().remove(tobeDeleteUser.getUsername());
	...
	private void getContactList() {
		contactList.clear();
		Map<String, User> users = ApplicationPool.getInstance().getContactList();
