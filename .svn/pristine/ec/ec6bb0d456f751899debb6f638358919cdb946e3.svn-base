...
import com.seeyuan.logistics.adapter.SelectGoodsAdapter;
 ...
 * 
 */
public class SelectGoodsManagerActivity extends BaseActivity implements
	...
	private void initAdapter() {
		...
		mAdapter = new SelectGoodsAdapter(mDataList, context);
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("goodsInfo", mDataList.get((int)id));
	...
	public void onClick(View view) {
		...
		case R.id.maintitle_back_iv:
			CommonUtils.finishActivity(SelectGoodsManagerActivity.this);
			break;
		}
	}
