 ...
 * 
 */
public class UpdateAccountHandler extends DataHandler {
	private Context mContext;
	private String server_url;
	private PdaRequest<AccountDto> accountDto;

	public UpdateAccountHandler(Context context, PdaRequest<AccountDto> accountDto) {
		this.mContext = context;
		this.server_url = NetWork.UPDATE_ACCOUNT_ACTION;
	...
	protected void onNetReceiveOk(byte[] receiveBody) {
		sendResult(NetWork.UPDATE_ACCOUNT_OK, receiveBody);
	}

	@Override
	protected void onNetReceiveError(int errorCode) {
		sendResult(NetWork.UPDATE_ACCOUNT_ERROR, errorCode);
	}
