 ...
 * 
 */
public class DeleteAccountHandler extends DataHandler {
	private Context mContext;
	private String server_url;
	private PdaRequest<AccountDto> accountDto;

	public DeleteAccountHandler(Context context, PdaRequest<AccountDto> accountDto) {
		this.mContext = context;
		this.server_url = NetWork.DELETE_ACCOUNT_ACTION;
	...
	protected void onNetReceiveOk(byte[] receiveBody) {
		sendResult(NetWork.DELETE_ACCOUNT_OK, receiveBody);
	}

	@Override
	protected void onNetReceiveError(int errorCode) {
		sendResult(NetWork.DELETE_ACCOUNT_ERROR, errorCode);
	}
