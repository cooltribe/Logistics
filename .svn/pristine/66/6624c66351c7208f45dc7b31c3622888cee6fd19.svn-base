 ...
 * 
 */
public class AgreementAndStatementActivity extends BaseActivity implements
		OnClickListener {
	...
	private String WEB_PATH = "http://192.168.2.32:8080/ep";
	...
	public void initView() {
		...
		defaulttitle_title_tv.setText(R.string.agreement_statement_hint);
	...
	private void initWebView() {
		...
		web_content.setWebChromeClient(new WebChromeClient() {
			public void onProgressChanged(WebView view, int progress) {
				AgreementAndStatementActivity.this.setProgress(progress * 100);
			}
		});
	}
	...
	public void onClick(View view) {
		...
		case R.id.maintitle_back_iv:
			CommonUtils.finishActivity(AgreementAndStatementActivity.this);
			break;
