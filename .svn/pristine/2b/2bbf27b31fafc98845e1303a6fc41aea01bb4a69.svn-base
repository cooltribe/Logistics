 ...
 * 
 */
public class ProductHelpActivity extends BaseActivity implements
		OnClickListener {
	...
	public void initView() {
		...
		defaulttitle_title_tv.setText(R.string.help_title);
	...
	private void initWebView() {
		...
		web_content.setWebChromeClient(new WebChromeClient() {
			public void onProgressChanged(WebView view, int progress) {
				ProductHelpActivity.this.setProgress(progress * 100);
			}
		});
	}
	...
	public void onClick(View view) {
		...
		case R.id.maintitle_back_iv:
			CommonUtils.finishActivity(ProductHelpActivity.this);
			break;
